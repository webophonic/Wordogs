...
class Wordogs_Admin {
	 ...
	 *
	 * @since    0.1.0
	 * @param      string    $WORDOGS       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->WORDOGS, plugin_dir_url( __FILE__ ) . 'css/wordogs-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->WORDOGS, plugin_dir_url( __FILE__ ) . 'js/wordogs-admin.js', array( 'jquery' ), $this->version, false );
